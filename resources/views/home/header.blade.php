        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('blog')}}l">Blog</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('show_cart')}}"><i class="fa fa-shopping-basket"></i></a>
                    </li>
                    ...
                    @if (Route::has('login'))
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="btn btn-primary" href="{{ route('register') }}">Registr</a>
                            </li>
                        @endauth
                    @endif
                    {{--                    <li class="nav-item">--}}
